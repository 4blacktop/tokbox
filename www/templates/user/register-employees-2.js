this_page = function() {
    return {
        get_data: function() {
            ...
            data = $.core.get_from_api('multi/?requests={"regions": {}, "education_requirements": {}}', error_msg);
        ...
        after_load: function() {
            ...
            // Init file upload
            $('#register-employees-2 input[name="cover_photo"]').file_upload('image', 'profile_pic', 'user-profile_pic');
            $('#register-employees-2 input[name="resume"]').file_upload('image', 'resume_uri', 'user-resume_uri');
            $('#register-employees-2 input[name="video"]').file_upload('video', 'raw_video_uri', 'user-video');
            ...
            $.each(['education'], function(i, thing) {
        ...
        register_cb: function(response) {
            ...
            if (typeof(data.user) == 'object') {
                ...
                // Show success
                $.core.show_success($.i18n._('Almost Done! Last page...'));

                // Redirect to 3rd page
                window.setTimeout("$.mobile.navigate('#register-employees-3')", 1500);
            }else{
                // Show error
